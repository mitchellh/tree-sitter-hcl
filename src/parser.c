...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(172)] = 7949,
  [SMALL_STATE(173)] = 7978,
  [SMALL_STATE(174)] = 8003,
  [SMALL_STATE(175)] = 8036,
  ...
  [SMALL_STATE(205)] = 9041,
  [SMALL_STATE(206)] = 9061,
  [SMALL_STATE(207)] = 9076,
  [SMALL_STATE(208)] = 9090,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [107] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_splat_full_repeat1, 2), SHIFT_REPEAT(39),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_splat_full_repeat1, 2), SHIFT_REPEAT(256),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splat_full, 3),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splat_full, 3),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [119] = {.entry = {.count = 1, .reusable = false}}, SHIFT(256),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splat_full, 4),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splat_full, 4),
  ...
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_splat_attr_repeat1, 2), SHIFT_REPEAT(256),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_template, 2),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quoted_template, 2),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splat_attr, 2),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splat_attr, 2),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_template, 3),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quoted_template, 3),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splat_attr, 3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splat_attr, 3),
  ...
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_tuple, 4),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__for_tuple, 4),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 2),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_object, 7),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__for_object, 7),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_term, 1),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_term, 1),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_get_attr, 2),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_get_attr, 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 6),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 6),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_object, 6),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__for_object, 6),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splat, 1),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splat, 1),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 5),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 5),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_tuple, 5),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__for_tuple, 5),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 5),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple, 5),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 5),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 5),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_term, 2),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_term, 2),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_value, 1),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal_value, 1),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_collection_value, 1),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_collection_value, 1),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index, 3),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index, 3),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_expr, 1),
  [224] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_expr, 1),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_object, 8),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__for_object, 8),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 4),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4),
  [236] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 3),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 3),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_expr, 1),
  [244] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_expr, 1),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_term, 3),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_term, 3),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 2),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple, 2),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 4),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple, 4),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 3),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple, 3),
  [262] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [264] = {.entry = {.count = 1, .reusable = false}}, SHIFT(237),
  ...
  [300] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_splat_full_repeat1, 2), SHIFT_REPEAT(28),
  [303] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_splat_full_repeat1, 2), SHIFT_REPEAT(260),
  [306] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_splat_attr_repeat1, 2), SHIFT_REPEAT(260),
  ...
  [373] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object_elem, 3),
  ...
  [446] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(219),
  [449] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(205),
  [452] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tuple_repeat1, 2), SHIFT_REPEAT(30),
  ...
  [463] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [465] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(23),
  [468] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 2),
  [470] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(23),
  ...
  [487] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_quoted_template_repeat1, 2),
  [489] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_quoted_template_repeat1, 2), SHIFT_REPEAT(213),
  ...
  [522] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_line_block, 7),
  [524] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_line_block, 8),
  [526] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 1),
  [528] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_line_block, 5),
  [530] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 4),
  [532] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 7),
  ...
  [546] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_line_block, 4),
  [548] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2),
  ...
  [556] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 6),
